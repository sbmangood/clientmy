...
const quint8 BIGCLASSROOM_PROTOCOL_VER =2;
...
const QString kSocketSpeak = "speak";
const QString kSocketSendRedPackets = "redPacket";
const QString kSocketHitRedPacket = "redPacketReq";
const QString kSocketRedPacketResp = "redPacketResp";
const QString kSocketEndRedPackets = "redPacketFin";
const QString kSocketAppId = "appId";
const QString kSocketGroupId = "groupId";
const QString kSocketBusinessType = "businessType";
const QString kSocketExtraInfo = "extraInfo";
const QString kSocketQuestion = "question";
