    ...
    Column{
        ...
        MouseArea{
            ...
            Image {
                ...
                visible: isVisible
                source: parent.containsMouse ? "qrc:/images/xbk_icon_jia_dianji.png" : "qrc:/images/xbk_icon_jia.png"
            }
        ...
        MouseArea{
            ...
            Image{
                ...
                width: 15 * heightRate
                height: 2 * heightRate
                source: parent.containsMouse ? "qrc:/images/xbk_icon_jian_dianji.png" : "qrc:/images/xbk_icon_jian.png"
                anchors.centerIn: parent
            }
