...
Item {
    ...
    Image {
        anchors.fill: parent
        source: currentViewType == 1 ? "qrc:/images/xb_xianshiqi4@2x.png" : (currentViewType == 2 ? "qrc:/images/xb_xianshiqi2@2x.png" : "qrc:/images/xb_xianshiqi3@2x.png")
    }
    ...
    Image {
        ...
        source: "qrc:/images/xb_button_ljqd1@2x.png"
        anchors.bottom: parent.bottom
        ...
        MouseArea
        {
            ...
            onPressed:
            {
                startButton.source = "qrc:/images/xb_button_ljqd2@2x.png";
            }

            onReleased:
            {
                startButton.source = "qrc:/images/xb_button_ljqd1@2x.png";
            }
