...
void YMCoursewareManager::sendSigPlayAnimation(QString pageId, int step)
{
    emit sigPlayAnimation(pageId, step);
}

void YMCoursewareManager::sendSigH5GoPage(int pageIndex)
{
    emit sigH5GoPage(pageIndex);
}

void YMCoursewareManager::sendSigH5AddPage()
{
    emit sigH5AddPage();
}

void YMCoursewareManager::sendSigH5DelPage()
{
    emit sigH5DelPage();
}

void YMCoursewareManager::sendSigAnimationInfo(int pageNo, int step)
{
    emit sigAnimationInfo(pageNo, step);
}
