...
Item {
    ...
    Item {
        ...
        Image {
            width: 8 * widthRate
            height: 8 * widthRate
            source: "qrc:/images/xbk_btn_close.png"
        ...
        Image {
            ...
            source: "qrc:/images/xbk_icon_refresh.png"
            anchors.right: parent.right
        ...
        Row {
            ...
            Image {
                ...
                source: "qrc:/images/backMika@3x.png"
                MouseArea
                {
                    anchors.fill:parent
                    cursorShape: Qt.PointingHandCursor
            ...
            Image {
                width: 11 * widthRate * 0.7
                height: 12 * widthRate * 0.7
                source: "qrc:/images/nextMika@3x.png"
                MouseArea
                {
                    anchors.fill:parent
                    cursorShape: Qt.PointingHandCursor
