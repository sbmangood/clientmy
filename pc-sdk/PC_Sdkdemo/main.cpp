...
#define MSG_BOX_TITLE  QString(u8"溢米云直播")
...
int main(int argc, char *argv[])
{
    ...
    QSharedMemory shared("PC_Sdkdemo");
    if (shared.attach())
    {
        ...
        qDebug() << QString("PC_Sdkdemo has already been running, please exit and run again.") << __LINE__;
        return 0;
    }
    shared.create(1);
