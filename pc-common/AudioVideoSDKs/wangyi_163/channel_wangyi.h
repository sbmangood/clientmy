...
private:
    ...
    static void AddVideoFrame(bool capture, unsigned __int64  time, const char* data, unsigned int size, unsigned int width, unsigned int height, const std::string& json, FrameType frame_type);
