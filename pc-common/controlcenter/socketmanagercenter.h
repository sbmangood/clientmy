...
public:
    ...
    virtual void onPersonData(const QString &address, int udpPort, int port, bool isTcpProtocol);

    virtual QString getNetWorkMode();
    virtual int getPersonData(QString &address, int &udpPort, int &port, bool &isTcpProtocol);
    virtual int getServerQosInfo(int &serverDelay, int &serverLost);
