...
const LogEntry_Company LogEntry_Company_Company_MAX = LogEntry_Company_JRONLINE;
...
class LogEntry_LiveInfo :
 ...
 private:
  ...
  ::google::protobuf::internal::ArenaStringPtr classtype_;
  int lessontype_;
  mutable ::google::protobuf::internal::CachedSize _cached_size_;
  friend struct ::TableStruct_galaxy_5fmessage_2eproto;
};
...
class LogEntry :
 ...
 public:
  ...
  static const Company JRONLINE =
    LogEntry_Company_JRONLINE;
...
// string classType = 5;
inline void LogEntry_LiveInfo::clear_classtype() {
  classtype_.ClearToEmptyNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline const ::std::string& LogEntry_LiveInfo::classtype() const {
  // @@protoc_insertion_point(field_get:LogEntry.LiveInfo.classType)
  return classtype_.GetNoArena();
}
inline void LogEntry_LiveInfo::set_classtype(const ::std::string& value) {
  
  classtype_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), value);
  // @@protoc_insertion_point(field_set:LogEntry.LiveInfo.classType)
}
#if LANG_CXX11
inline void LogEntry_LiveInfo::set_classtype(::std::string&& value) {
  
  classtype_.SetNoArena(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:LogEntry.LiveInfo.classType)
}
#endif
inline void LogEntry_LiveInfo::set_classtype(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  
  classtype_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
  // @@protoc_insertion_point(field_set_char:LogEntry.LiveInfo.classType)
}
inline void LogEntry_LiveInfo::set_classtype(const char* value, size_t size) {
  
  classtype_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:LogEntry.LiveInfo.classType)
}
inline ::std::string* LogEntry_LiveInfo::mutable_classtype() {
  
  // @@protoc_insertion_point(field_mutable:LogEntry.LiveInfo.classType)
  return classtype_.MutableNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline ::std::string* LogEntry_LiveInfo::release_classtype() {
  // @@protoc_insertion_point(field_release:LogEntry.LiveInfo.classType)
  
  return classtype_.ReleaseNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline void LogEntry_LiveInfo::set_allocated_classtype(::std::string* classtype) {
  if (classtype != nullptr) {
    
  } else {
    
  }
  classtype_.SetAllocatedNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), classtype);
  // @@protoc_insertion_point(field_set_allocated:LogEntry.LiveInfo.classType)
}
