...
#    $$PWD/beautyManager/*.cpp \
 #   $$PWD/beautyManager/beautymanager.cpp \
 #   $$PWD/beautyManager/renderWayA/GlobalValue.cpp \
#    $$PWD/beautyManager/renderWayA/Nama.cpp \
 #   $$PWD/beautyManager/renderWayA/GLWidget.cpp
