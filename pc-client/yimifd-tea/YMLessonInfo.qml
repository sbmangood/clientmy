...
MouseArea {
    ...
    signal sigShowLessonReportView(var showTypes, var lessonId, var studentId);
    ...
    onLessonDataChanged: {
        ...
        studentId = lessonData.studentId == undefined ? 0 : lessonData.studentId;
        ...
        reportFlag = lessonData.reportFlag;

        updateDisableClass();
        updateHasRecord();
        listenFlag = lessonMgr.getLessonComment(lessonId);
        console.log("listenFlag:",listenFlag,userId)
    }
    ...
    Rectangle{
        ...
        MouseArea{//试听课报告按钮
            ...
            Rectangle{
                radius: 2 * heightRate
                color: lessonType == "O" ? (lessonStatus == 1 ? "#f3f6f9" : "#f9f9f9") : (listenFlag == 1 || listenFlag == 2) && lessonStatus == 1 ? "#f3f6f9" : "#f9f9f9"
                anchors.fill: parent
                border.width: 1
                border.color: lessonType == "O" ? (lessonStatus == 1 ? "#f3f6f9" : "#f9f9f9") : ((listenFlag == 1 || listenFlag == 2) && lessonStatus == 1  ?  "#f3f6f9" : "#f9f9f9")
                ...
                Image {
                    ...
                    anchors.topMargin: (parent.height - height - courseText.height) * 0.5
                    anchors.horizontalCenter: parent.horizontalCenter
                    source: lessonStatus == 1 ? "qrc:/images/popwindow_btn_report_defult.png" : "qrc:/images/popwindow_btn_report_disable.png"
                }
                ...
                Text{
                    ...
                    font.family: Cfg.LESSON_INFO_FAMILY
                    font.pixelSize: (Cfg.LESSON_FONT_SIZE - 2) * heightRate
                    color: lessonStatus == 1 ? "#333333" : "#aaaaaa"
            ...
            onClicked: {
                ...
                if(listenFlag == 1){
                    ...
                    sigShowLessonReportView(1,lessonId, studentId);
                    animateOutOpactiy.start();
                    return;
                }
            }
