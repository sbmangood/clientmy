            ...
            Item{
                ...
                Row{
                    ...
                    MouseArea{
                        width: 80 * widthRate
                        height: 35 * heightRate
                        enabled: lessonStatus == 1 //(subjectName == "演示" || lessonType == 10) ? (lessonStatus == 1):(listenFlag == 0 ? (lessonStatus == 1 ? true : false) : (lessonStatus == 1 ? true : false))//(listenFlag == 0 && lessonStatus == 1  && lessonType == 0) ? true : false
                        anchors.verticalCenter: parent.verticalCenter
                        cursorShape: Qt.PointingHandCursor
                        ...
                        Image{
                            ...
                            height: 24 * heightRate
                            anchors.verticalCenter: parent.verticalCenter
                            source:lessonStatus == 1 ? "qrc:/images/list_report@2x.png" : "qrc:/images/popwindow_btn_report_disable.png"
                        }
...
//                                    }
                        ...
                        onClicked: {
                            ...
                            if(listenFlag == 1){
                                ...
                                lessonReport.setReportView(1,lessonId, studentId);
                                return;
                            }
                            if(listenFlag == 0)
                            {
                                url = URL_ClassroomReport + lessonId + "&report=1";
                                console.log(url);
                                Qt.openUrlExternally(url);
                                return;
                            }
    ...
    function analysisData(objectData){
        ...
        for(var i = 0; i < items.length; i++){
            teachModel.append({
                                  ...
                                  "studentId": items[i].studentId == undefined ? 0 : items[i].studentId,
                                  "reportFlag": items[i].reportFlag,
