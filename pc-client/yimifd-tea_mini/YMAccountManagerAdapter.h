...
class YMAccountManagerAdapter : public QObject
{
    ...
    public:
        ...
        Q_INVOKABLE void talkUserLogin(QString userName,QString passWork);//小班课登录
        Q_INVOKABLE void talkGetUserInfo();//获取小班课登录信息
    ...
    signals:
        ...
        void  sigTokenFail();
        void sigTalkLoginInfo(QJsonObject dataObject);//小班课登录信息
        void sigTalkTeacherInfo(QJsonObject teacherInfo);//小班课登录老师信息
