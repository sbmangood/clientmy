...
QJsonObject YMHomeWorkManagerAdapter::getQuestionStatus(QString lessonWorkId)
{
    ...
    {
        qDebug() << "YMHomeWorkManagerAdapter::getQuestionStatus::dataObject" << objectData;
    }
    return objectData;
...
void YMHomeWorkManagerAdapter::getCurrentStage()
{
    ...
    qDebug() << "YMHomeWorkManagerAdapter::getCurrentStage" << netType << stageInfo << __LINE__;
...
{
    qDebug() << "YMHomeWorkManagerAdapter::updateStage" << netType << stageInfo << __LINE__;
