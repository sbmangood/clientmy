...
*网络设置
*/
//内部测试环境的切换窗口(生产环境, Stage环境, Pre环境, Dev环境)
...
Item {
    ...
    MouseArea{
        ...
        onClicked: {
                ...
                console.log("=======updateStage========", stageArray[0], stageArray[1]);
                homeWorkMgr.updateStage(stageArray[0],stageArray[1]);
        }
    }
    ...
    Component.onCompleted: {
        netModel.append({"id": 0, "selected": false,"netText": "生产环境","stage": "", "type": "1" });
    ...
    function updateSelecte(index){
        console.log("=======updateSelecte========1", index);
