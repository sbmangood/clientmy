...
Rectangle {
    ...
    onDataModelChanged: {
        ...
        button1.y = 0;
        //console.log("====cloudComposite::baseImages1111====",baseImages,JSON.stringify(baseImageObj));
    }
    ...
    Item {
        ...
        Rectangle {
            ...
            MouseArea {
                ...
                // 拖动
                onMouseYChanged: {
                    topicListView.contentY = button.y / button1.height * topicListView.contentHeight
                }
            }
        }
    }
        ...
        Rectangle{
            ...
            /*{
                ...
                if(topiceType >= 1 && topiceType < 5){
                    var currentType1 = topicListView.height * 0.5  + maxCount * 50 * heightRate ;
                    return currentType1 < topicListView.height ? topicListView.height : currentType1;
                }

                if(topiceType == 5){
                    //console.log("=====maxCount=====",maxCount);
                    var currentType5 = topicListView.height + maxCount * 100 * heightRate//topicListView.height * 0.5 + knowledges.count * 300 * heightRate
            ...
            Component{
                ...
                Rectangle{
                    ...
                    function analysisData(index){
                        ...
                        //console.log("=====questionTypes======",questionTypes,JSON.stringify(questionItemsModel));
                        //console.log("=====questionTypes111======",JSON.stringify(knowledges));
                    ...
                    Component.onCompleted: {
                        //console.log("======Component.onCompleted======",childQuestionInfo,childQuestionInfo.count);
