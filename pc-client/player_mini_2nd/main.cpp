...
//    QMessageBox::critical(NULL, "aaa", strAppFileName, QMessageBox::Ok, QMessageBox::Ok); //测试中文乱码
    ...
    QSharedMemory shared("miniclass_player"); //exe被复制粘贴以后, 还是只能运行一个
    if (shared.attach())
    {
    ...
    boardList.append(QString::fromUtf8(QByteArray::fromHex(QByteArray(argv[2]))));//相关信息
    boardList.append(QString::fromUtf8(QByteArray::fromHex(QByteArray(argv[3]))));//路径
    boardList.append(QString::fromUtf8(argv[4]));//轨迹文件名
    boardList.append(QString::fromUtf8(argv[5]));//类型（学生或者老师)

    YMUserBaseInformation::type =  QString::fromUtf8(argv[5]);//"TEA";//
    YMUserBaseInformation::token =  QString::fromUtf8(argv[6]);//"83673cbf7a2077f65e8ade55b12550f2";//
    YMUserBaseInformation::apiVersion = QString::fromUtf8(argv[7]);//"2.4";//
    YMUserBaseInformation::appVersion =  QString::fromUtf8(argv[8]); //"2.4.0005";//
    YMUserBaseInformation::lessonId  = QString::fromUtf8(argv[1]);//"300572"; //
    StudentData::gestance()->m_lessonId = QString::fromUtf8(argv[1]);
    YMUserBaseInformation::id = QString::fromUtf8(argv[9]);

//    YMUserBaseInformation::type =  "TEA";//QString::fromUtf8(argv[6]);//
//    YMUserBaseInformation::token =  "yimi_334055616085516305_huangshiquan008_07qN1P_1564985820846";//QString::fromUtf8(argv[7]);//
//    YMUserBaseInformation::apiVersion = "2.4";//QString::fromUtf8(argv[8]);//
//    YMUserBaseInformation::appVersion =  "4.01.06.132";//QString::fromUtf8(argv[9]); //
//    YMUserBaseInformation::lessonId = "342976901167472684"; //QString::fromUtf8(argv[1]);//
//    YMUserBaseInformation::id = "306387697340014723";
//    StudentData::gestance()->m_lessonId = "342976901167472684";
