...
*/
        ...
        YMTipsMediaPlayView{
            ...
            visible: false
            onSigOk: {
                painterBoardMgr.setMediaStatus(true)
                painterBoardMgr.play();
                audioMedia.play();
            }
            onSigCancel: {
                painterBoardMgr.setMediaStatus(false)
                painterBoardMgr.play();
                audioMedia.play();
            }
        }
        ...
        PainterBoard{
            ...
            onChangeBgimg: {
                ...
                if(currentDocType == 3){
                    ...
                    painterBoardMgr.getOffSetImage(0,0,1.0);
                    return;
                }
    ...
    YMPlayerControl{
        ...
        onSeekMedia: {
            knowledgesView.close();
            modifyHomework.close();
            painterBoardMgr.seekTime(position);
        }
    }

    Component.onCompleted: {
        menuView.displayerText = boardList[1];
        var lessonId =  boardList[0];//"623124"//
        var date =  "201902";
        var filePath = boardList[2];//"C:/Users/Administrator/Documents/YiMi/201712/623124";//
        var trailName = boardList[3]//"8.encrypt";//
//        console.log("==========",lessonId,filePath,trailName);


//        var lessonId =  "342976901167472684"//
//        var date =  "201906"//
//        var filePath = "C:/Users/Administrator/Documents/YiMi/342976901167472684"; //201812/1906505";//"
//        var trailName = "3.txt"; //"2.encrypt";//

        currentLessonId = lessonId;
        painterBoardMgr.setData(lessonId,date,filePath,trailName,2);
