...
Popup {
   ...
   closePolicy:toobarWidget.teacherEmpowerment ? Popup.CloseOnPressOutside : Popup.NoAutoClose
    ...
    onDataModelChanged: {
        ...
        //        {
        //            if(dataModel.id == workModel.get(0).id)
        //            {
        //                return;
        //            }
        //        }
    ...
    ListView{
        id: homeworkListView
        clip: true
        width: parent.width - 15 * widthRate
        height: 80 * heightRate * workModel.count
        delegate: homeWorkDelegate
        model: workModel
        anchors.top: parent.top
        anchors.topMargin: 25 * widthRate
        anchors.horizontalCenter: parent.horizontalCenter
    }
        ...
        Rectangle{
            ...
            Row{
                ...
                MouseArea{
                    ...
                    visible: questionType <= 3 ?( isRight != 0 ? true : false ) : correStatus == 4 ? ( isCompare == -1 ? false : isCompare == 1 ? true : false) : false
                    enabled: !isOk

                    Image{
                        anchors.fill: parent
                        source: isCompare == 1 ? "qrc:/newStyleImg/pigai_dui_sed@2x.png" : parent.containsMouse ? "qrc:/newStyleImg/pigai_dui_sed@2x.png" : "qrc:/cloudImage/icon_dui@2x.png"
                    }
                ...
                MouseArea{
                    ...
                    cursorShape: Qt.PointingHandCursor
                    anchors.verticalCenter: parent.verticalCenter
                    visible: questionType <= 3 ? ( isRight != 0 ? false : true ) : correStatus == 4 ? (isCompare == -1 ? false : isCompare == 0 ? true : false) :false

                    Image{
                        anchors.fill: parent
                        source: isCompare == 0 ? "qrc:/newStyleImg/pigai_cuo_sed@2x.png" : parent.containsMouse ? "qrc:/newStyleImg/pigai_cuo_sed@2x.png" : "qrc:/newStyleImg/pigai_cuo@2x.png"
                    }
                ...
                MouseArea{
                    ...
                    cursorShape: Qt.PointingHandCursor
                    anchors.verticalCenter: parent.verticalCenter
                    visible:questionType <= 3 ? false : correStatus == 4 ? ( isCompare == -1 ? false : isCompare == 2 ? true : false ) : false

                    Image{
                        anchors.fill: parent
                        source:  isCompare == 2 ? "qrc:/newStyleImg/pigai_bandui_sed@2x.png" : parent.containsMouse ? "qrc:/newStyleImg/pigai_bandui_sed@2x.png" : "qrc:/newStyleImg/pigai_bandui@2x.png"
                    }
                    onClicked: {
                        if(isCompare == -1){
                            isCompare = 2;
