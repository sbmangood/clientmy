...
class CurriculumData : public QObject
{
    ...
    Q_PROPERTY(int subjectId READ subjectId)
    Q_PROPERTY(int lessonType READ lessonType)
    Q_PROPERTY(int applicationType READ applicationType)
public:
    ...
    //判断是否还有老师在教室内
    Q_INVOKABLE bool justHasTeacherInRoom();
