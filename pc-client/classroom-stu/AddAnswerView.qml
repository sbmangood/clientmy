...
Rectangle {
    ...
    Rectangle
    {
        ...
        anchors.bottomMargin:  - 35 * heightRate
        ...
        Row
        {
            ...
            Rectangle {
                ...
                Image {
                    ...
                    anchors.left: parent.left
                    anchors.verticalCenter: parent.verticalCenter
                    source:!addWriteMouseArea.containsMouse ? "qrc:/newStyleImg/btn_shouxie_disable@2x.png" : "qrc:/newStyleImg/btn_shouxie@2x.png"//btn_shouxie@2x
                }
                Text {
                    ...
                    anchors.leftMargin: 8 * heightRate
            ...
            Rectangle {
                ...
                Image {
                    ...
                    anchors.left: parent.left
                    anchors.verticalCenter: parent.verticalCenter
                    source:addImageMouseArea.containsMouse ? "qrc:/newStyleImg/btn_zhaopian@2x.png" : "qrc:/newStyleImg/btn_zhaopian_disable@2x.png"//btn_shouxie@2x
                }
                Text {
                    //height:parent.height
                    text: qsTr("添加图片")
        ...
        Rectangle
        {
            ...
            width: 200 * heightRate * 0.8
            height: 44 * heightRate * 0.8
            color: "#ff5000"
            radius: 5 * heightRate
            anchors.verticalCenter: parent.verticalCenter
            anchors.right: parent.right
        ...
        Rectangle{
            ...
            anchors.rightMargin: -43 * heightRate
            color:"transparent"
            Rectangle
            {
                id: upButton
                width: 80 * heightRate * 0.8
                height: 44 * heightRate * 0.8
                border.width: 1
