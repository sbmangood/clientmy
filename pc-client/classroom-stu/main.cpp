...
int main(int argc, char *argv[])
{
    ...
    YMQosManager::gestance()->initQosManager(backData,"stu");//初始化qosManager "tea/stu/cc/audit,
    //获取客户端基本信息
    ...
    if(!baseData.isEmpty()){
        ...
        QString valueCrashMsg ="teastudentclassroom crash";
    ...
    if(!StudentData::gestance()->apiUrl.contains("test-api"))//判断是否是公测
    {
    ...
    {
        app.setWindowIcon(QIcon(":/images/yimiico_public_test_stu.ico"));
    }
