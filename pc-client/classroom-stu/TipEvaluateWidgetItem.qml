...
Rectangle {
    ...
    property string paramTitle1: "授课内容是否合适";
    property string paramTitle2: "教学态度是否合适";
    property string paramTitle3: "课后作业是否布置";
    ...
    Text {
        ...
        font.family: "Microsoft YaHei"
        z:3
        text: '<font >*</font><font color="#708090">'+paramTitle1+'</font>'
    ...
    Text {
        ...
        font.family: "Microsoft YaHei"
        z:3
        text: '<font >*</font><font color="#708090">'+ paramTitle2 +'</font>'
    ...
    Text {
        ...
        font.family: "Microsoft YaHei"
        z:3
        text: '<font >*</font><font color="#708090">'+ paramTitle3 +'</font>'
    }
    ...
    Rectangle{
        ...
        enabled:tipEvaluateWidgetItem.teachingContentType > 0 ?(tipEvaluateWidgetItem.teachingAttitudeType > 0 ? ( tipEvaluateWidgetItem.homeworkType > 0 ? true : false ): false ): false
        color: "#ff5000"
