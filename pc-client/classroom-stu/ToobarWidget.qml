    ...
    Item {
        ...
        Rectangle {
            ...
            Image {
                ...
                anchors.topMargin: 10 * leftMidWidth / 66.0- rectShadow.radius;
                anchors.leftMargin: 8 * leftMidWidth / 66.0;
                width: parent.width - 18 * leftMidWidth / 66.0;
                height: parent.width
            ...
            Rectangle{
                ...
                anchors.leftMargin: 8 *  leftMidWidth / 66.0
                width: 35 *  leftMidWidth / 66.0
                height:  35 *  leftMidWidth / 66.0
                color: "#00000000"
                Image {
                    id: brushImage
                    anchors.left: parent.left
                    ...
                    //source: teacherEmpowerment ?  "qrc:/images/cr_btn_pen.png" : "qrc:/newStyleImg/pc_tool_pen@2x.png"
                }
                MouseArea{
                    anchors.fill: parent
                    hoverEnabled: true
            ...
            Rectangle{
                ...
                anchors.topMargin: 20 * leftMidWidth / 66.0
                anchors.leftMargin: 8 *  leftMidWidth / 66.0
                width: 35 *  leftMidWidth / 66.0
                height: 35 *  leftMidWidth / 66.0
                color: "#00000000"
            ...
            Rectangle{
                ...
                Image {
                    ...
                    //source: teacherEmpowerment ? "qrc:/images/cr_btn_emoji.png" :"qrc:/newStyleImg/pc_tool_emoji@2x.png"
                }
                MouseArea{
                    anchors.fill: parent
                    hoverEnabled: true
            ...
            Rectangle{
                ...
                Image {
                    ...
                    //source: teacherEmpowerment ? "qrc:/images/cr_btn_shape.png" : "qrc:/newStyleImg/pc_tool_shape@2x.png"
                }
                MouseArea{
                    anchors.fill: parent
                    hoverEnabled: true
