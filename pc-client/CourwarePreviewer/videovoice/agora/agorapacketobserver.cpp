...
{
    //qDebug()<<"AgoraPacketObserver::onCaptureVideoFrame a";
...
{
    //qDebug() <<"AgoraPacketObserver::onRenderVideoFrame";
    if(videoFrame.yBuffer == NULL)
    {
        return false;
    }
    ...
    QImage image = QImage(m_arr.data(), y, h, QImage::Format_RGB888).copy(0, 0, w, h);
...
void AgoraPacketObserver::setInitStartClass(bool status)
{
    m_isInitStartClass = status;
}
