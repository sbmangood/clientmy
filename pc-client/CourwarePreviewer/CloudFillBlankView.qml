...
Item {
    ...
    onDataModelChanged: {
        ...
        if(baseImages != ""){
            if(imgheight > fillblankView.height){
    ...
    Component{
        ...
        Item{
            ...
            height: {
                return fillblankView.height * 0.4 + topicRow.height + photosModel .count * fillblankView.height + questionItemsModel.length * 160 * heightRate
            }
            onHeightChanged: {
                if(clipStatus){
                ...
                console.log("=====cloudFillBlankView::width====",height,topicListView.height);
            }
            ...
            Row{
                ...
                WebEngineView{
                    id: questionTitle
                    enabled: true
                    width: parent.width - 20 * heightRate - topicType.width
            ...
            ListView{
                ...
                height: parent.height  - topicRow.height  - 50 * heightRate -  photosModel .count * fillblankView.height + questionItemsModel.length * 160 * heightRate
                anchors.top: topicRow.bottom
                anchors.topMargin: 10 * heightRate
                anchors.horizontalCenter: parent.horizontalCenter
            ...
            Component.onCompleted: {
                if(photosModel.count == 0 && clipStatus && topicModel.count - 1 == index){
                    sigLoadingSuccess();
                    console.log("======clip22222222222222======");
                }
            }
        }
    }
