...
Item {
    ...
    Component{
        ...
        Item {
            ...
            height: multipleView.height * 0.6 + bufferQuestionItemsModel.length / 2 * selectionItemGridViews.cellHeight
    ...
    Component{
        ...
        Item {
            ...
            onCurrentViewModelsChanged: {
                backgundItem.color = currentViewModel == 1 ? (isBeselects ? "#FF7B44" : "#C3C6C9") : (bufferQuestionItemsModel[index].isright ? "#44EAC6": (isBeselects ? "#FF7777" : "#C3C6C9")  )
            }
            ...
            Rectangle {
                ...
                //color: currentViewModel == 1 ? (isBeSelect ? "#FF7B44" : "#C3C6C9") : ( isright ? "#44EAC6": (isBeSelect ? "#FF7777" : "#C3C6C9")  )
            ...
            Component.onCompleted: {
                console.log("=====MultipleChoiceQuestion========",index,questionItemsModel.length -1);
