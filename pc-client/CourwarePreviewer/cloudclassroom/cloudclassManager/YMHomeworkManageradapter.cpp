...
QJsonObject YMHomeWorkManagerAdapter::getLessonWorkList(QString pageIndex, QString lessonWorkStatus)
{
    ...
    {
        qDebug() << "YMHomeWorkManagerAdapter::getLessonWorkList" << objectData;
    }
    return objectData;
}
...
bool YMHomeWorkManagerAdapter::saveStudentAnswer(QString lessonWorkId, QString questionId, QString studentAnswer, QString useTime, QString photos, QString writeImages)
{
    ...
    qDebug() << "YMHomeWorkManagerAdapter::saveStudentAnswer" << QString::fromUtf8(dataByte);
    return false;
    //返回的数据格式
...
bool YMHomeWorkManagerAdapter::updateLessonWorkStatus(QString lessonWorkId)
{
    ...
    qDebug() << "YMHomeWorkManagerAdapter::updateLessonWorkStatus" << QString::fromUtf8(dataByte);
    return false;
...
QJsonObject YMHomeWorkManagerAdapter::getAnswerCard(QString lessonWorkId)
{
    ...
    if(!result.contains("success"))
    {
        qDebug() << "YMHomeWorkManagerAdapter::getAnswerCard::dataObj" << objectData;
    }
    return objectData;
...
bool YMHomeWorkManagerAdapter::updateReaded(QString lessonWorkId)
{
    ...
    qDebug() << "YMHomeWorkManagerAdapter::updateReaded::Fail" << QString::fromUtf8(dataByte);
    return false;
...
QJsonObject YMHomeWorkManagerAdapter::getQuestionStatus(QString lessonWorkId)
{
    ...
    if(!result.contains("success"))
    {
        qDebug() << "YMHomeWorkManagerAdapter::getQuestionStatus::Fail" << result << objectData;
    }
    return objectData;
...
bool YMHomeWorkManagerAdapter::getFinishLessonWork(QString lessonWorkId)
{
    ...
    qDebug() << "YMHomeWorkManagerAdapter::getFinishLessonWork::dataObj" << isFinish << objectData ;
    return isFinish;
}
    ...
    double score/*得分（主观题才有）*/)
{
    ...
    qDebug() << "===YMHomeWorkManagerAdapter::saveTeacherComment::Fail" << isFinish << objectData;
    return isFinish;
}
...
QJsonArray YMHomeWorkManagerAdapter::getErrReason()
{
    ...
    qDebug() << "YMHomeWorkManagerAdapter::getErrReason::Fail" << objectData;
    return dataArray;
}
