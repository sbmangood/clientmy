        ...
        Rectangle{
            ...
            Row{
                ...
                MouseArea{
                    ...
                    Image{
                        anchors.fill: parent
                        source: isCompare == 1 ? "qrc:/cloudImage/pigai_dui_sed@2x.png" : parent.containsMouse ? "qrc:/cloudImage/pigai_dui_sed_hover@2x.png" : "qrc:/cloudImage/icon_dui@2x.png"
                    }
                ...
                MouseArea{
                    ...
                    Image{
                        anchors.fill: parent
                        source: isCompare == 0 ? "qrc:/cloudImage/pigai_cuo_sed@2x.png" : parent.containsMouse ? "qrc:/cloudImage/pigai_cuo_sed_hover@2x.png" : "qrc:/cloudImage/icon_cuo@2x.png"
                    }
                ...
                MouseArea{
                    ...
                    Image{
                        anchors.fill: parent
                        source:  isCompare == 2 ? "qrc:/cloudImage/pigai_bandui_sed@2x.png" : parent.containsMouse ? "qrc:/cloudImage/pigai_bandui_sed_hover@2x.png" : "qrc:/cloudImage/icon_bandui@2x.png"
                    }
                    onClicked: {
                        if(isCompare == -1){
                            isCompare = 2;
