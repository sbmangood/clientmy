...
//    QString httpsd = "http://api.yimifudao.com/v2.4/log/logUpload?" + QString("%1").arg(urls);
    QString httpsd = "http://" + StudentData::gestance()->apiUrl + "/log/logUpload?" + QString("%1").arg(urls);
...
QString DebugLog::uploadLog_To_OSS(QString logPath)
{
    ...
    QString key = QString("appLog/%1/${%2}-${%3}_%4").arg(times.toString("yyyy/MM/dd")).arg(StudentData::gestance()->m_lessonId).arg("STU").arg(fileName);
