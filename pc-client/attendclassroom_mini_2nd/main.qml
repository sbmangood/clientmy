...
Window {
    ...
    function setFullScrreen(types){
        ...
        if(types){
            ...
            trailBoardBackground.anchors.leftMargin = midWidthX - 5 * fullWidths / 1440.0
    ...
    Component.onCompleted: {
        ...
        videoToolBackground.updateNetworkStatus(3,3,0);
        cloudRoomMenu.getLessonCommentConfigInfo();
        trailBoardBackground.setCursorShapeType(0) //修改学生端, 进入教室, 默认的光标样式是手的问题
    ...
    Item{
        ...
        YMResponderViewForStu{
            ...
            onSigStuStartResponder:
            {
                trailBoardBackground.sendResponderMsg(2);
            }
        }
        //计时倒计时
        YMTimerView{
        ...
        CloudRoomMeun{
            ...
            anchors.top: parent.top
            anchors.left: parent.left
            anchors.leftMargin: (parent.width - rightWidth - width) * 0.54//62
            z:105
        ...
        Image {
            ...
            anchors.left: parent.left
            anchors.leftMargin: fullScreenType ? fullWidthX : (midWidthX - 5 * fullWidths / 1440.0)
            visible: cloudRoomMenu.visible// currentCourwareType == 2 // 1 为老课件 2 为新课件
            onWidthChanged:
            {
        ...
        TrailBoardBackground{
            ...
            onSigPromptInterfaceHandl: {
                ...
                if(inforces == "66" || inforces == "67" ){
                    if(inforces == "66") {//同意进入
                        videoToolBackground.setStartClassTimeData(curriculumData.getStartClassTimelen());
                        // bottomToolbars.whetherAllowedClick = false;
                    }
        ...
        BottomToolbars{
            ...
            anchors.left: parent.left
            anchors.bottom: parent.bottom
            anchors.leftMargin: 612  * fullWidths / 1440 + 20  * fullHeights / 900
            anchors.bottomMargin:  10  * fullHeights / 900
            width: 230 * fullWidths / 1440  //+ 40  * fullHeights / 900
...
//            anchors.topMargin: rightWidthY
        ...
        MouseArea{
            ...
            Image {
                anchors.fill: parent
                source: "qrc:/miniClassImage/expanback.png"
            }
            ...
            onSigSendFunctionKey: {
                ...
                switch(keys)
                {
                    ...
                    case 3:
                        ...
                        toobarWidget.handlBrushImageColor(brushWidget.penColor);
                    ...
                    case 4:
                        ...
                        trailBoardBackground.setCursorShapeType(1);
        ...
        BrushWidget{
            ...
            anchors.top:  parent.top
            anchors.topMargin: 370 * heightRate
            width: 203 * heightRate
            height: 228  * heightRate
            visible: false
            focus: false
            z:10
            onFocusChanged: {
        ...
        EraserWidget{
            ...
            anchors.rightMargin: 42 * heightRate
            anchors.top:  parent.top
            anchors.topMargin:  420 * heightRate
            ...
            onSigClearsCreeon: {
                trailBoardBackground.setClearCreeon(types,bottomToolbars.currentPage,bottomToolbars.totalPage)
            }
        ...
        InterfaceWidget{
            ...
            anchors.top:  parent.top
            anchors.topMargin:  58 * 2 * leftMidWidths + 30 *   leftMidWidths
            width: 297 * fullWidths / 1440
            height: 261  * fullHeights / 900
            z:100
            visible: false
            focus: false
            onFocusChanged: {
        ...
        PictureWidget{
            ...
            width: 110 * fullWidths / 1440
            height: 105  * fullHeights / 900
            z:10
            visible: false
            focus: false
            onFocusChanged: {
        ...
        GraphicWidget{
            ...
            anchors.leftMargin: -15 * fullWidths / 1440
            anchors.top:  parent.top
            anchors.topMargin:  58 * 5 * leftMidWidths + 60 *   leftMidWidths
            width: 206 * fullWidths / 1440
            height: 63  * fullHeights / 900
            z:10
            visible: false
            focus: false
            onFocusChanged: {
        ...
        DetectionNetwork{
            ...
            onSigCurrentNetStatus: {
                videoToolBackground.updateNetworkStatus(netStatus,netValue,lost);
            }
