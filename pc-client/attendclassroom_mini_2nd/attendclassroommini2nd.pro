...
win32: LIBS += -L$$PWD/videovoice/agora/lib/ -lagora_rtc_sdk

INCLUDEPATH += $$PWD/videovoice/agora/include
DEPENDPATH += $$PWD/videovoice/agora/include

win32: LIBS += -L$$PWD/videovoice/iLiveSDK/libs/ -liLiveSDK

INCLUDEPATH += $$PWD/videovoice/iLiveSDK/include
DEPENDPATH += $$PWD/videovoice/iLiveSDK/libs
