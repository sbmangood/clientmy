...
Item {
    ...
    function updateMainView(questionData,topiceModel) {
        ...
        console.log("**********JudgmentQuestionView=========",currentBeSelectAnswer,currentViewModel);
    ...
    Component{
        ...
        Rectangle {
            ...
            height: judgmentMainView.height * 0.5 +  questionItemsModel.length / 2 * selectionItemGridViews.cellHeight + 190 * heightRate + answerView.height
            onHeightChanged: {
                console.log("=====height====",height,clipImageStatus,isComplexClip)
                if(clipImageStatus){
                    if(isComplexClip){
            ...
            //singleQuestionListView.height * 0.5 + questionItemsModel.length / 2 * selectionItemGridViews.cellHeight
            color: "transparent"
        ...
        Rectangle {
            ...
            Rectangle {
                ...
                color: {
                    ...
                    //currentViewModel == 1 ? currentBeSelectAnswer == index ? "#FF7B44" : "#C3C6C9" : questionItemsModel[index].isright ? "#44EAC6" : currentBeSelectAnswer == index ? "#FF7777" : "#C3C6C9"
                }
                Image {
                    anchors.left: parent.left
