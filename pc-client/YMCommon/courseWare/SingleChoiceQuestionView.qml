...
Item {
    ...
    Component{
        ...
        Rectangle {
            ...
            GridView {
                ...
                width: singleQuestionListView.width - 60 * heightRates
                ...
                anchors.leftMargin: 40 * heightRates
            }
    ...
    Component {
        ...
        Rectangle {
            width: (singleQuestionListView.width - 60 * heightRates) / 2 // / 2 - 10 *heightRates
            height: width / 4
            color: "transparent";
            Rectangle {
