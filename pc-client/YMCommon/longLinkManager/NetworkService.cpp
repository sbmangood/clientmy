...
{
    //const std::string logcachepath = "./Mars/cache";
    //const std::string logpath = "./Mars";
    //const std::string nameprefix = "mars";
    //const std::string pubkey = "";

    //const int logcachedays = 21;

    //appender_set_console_log(false);
    //appender_open_with_cache(TAppenderMode::kAppednerSync, logcachepath.c_str(), logpath.c_str(), nameprefix.c_str(), logcachedays, pubkey.c_str());
