...
YMQosManagerForStuM::YMQosManagerForStuM(QObject *parent)
    : QObject(parent)
{
...
YMQosManagerForStuM::~YMQosManagerForStuM()
{

}

void YMQosManagerForStuM::initQosManager(QString initData,QString userType)
{
    getBePushedUrl();
    getDeviceInfo();
    getLocalBufferMsg();
...
void YMQosManagerForStuM::addBePushedMsg(QString msgHeaderType, QJsonObject msgData)
{
...
void YMQosManagerForStuM::pushMsgToServer(QByteArray msg)
{
...
QString YMQosManagerForStuM::getPushMsg(QString msgHeaderType, QJsonObject msgData)
{
    QJsonObject msgObj;
    ...
    qDebug()<<"YMQosManagerForStuM::getPushMsg msgObj"<<msgObj;
    return tempDoc.toJson(QJsonDocument::Compact);
}

void YMQosManagerForStuM::getLastExitMsgInfo()
{

}

void YMQosManagerForStuM::checkPushMsgToServe()
{
    //qDebug()<<"YMQosManagerForStuM::checkPushMsgToServe()"<<msgBufferList.size();
...
void YMQosManagerForStuM::onPushMsgToServerReply(QNetworkReply *reply)
{
    if(reply->error() == QNetworkReply::NoError)
    {
        ...
        qDebug()<<"YMQosManagerForStuM::onPushMsgToServerReply("<<dataObj.value("result").toString() << dataObj;
...
QString YMQosManagerForStuM::getMacString()
{
    QString  strMac;
    ...
    qDebug()<<"YMQosManagerForStuM::getMacString()"<<strMac;
    return strMac;
}

QString YMQosManagerForStuM::getCurrentNetWorkType()
{
    int types = 0;
    QString netWorkType = "";
...
void YMQosManagerForStuM::writeMsgToLocalBuffer(QString msgHeaderType,QJsonObject msgData)
{
    QString tempMsg = getPushMsg(msgHeaderType,msgData);
    //写入本地
...
void YMQosManagerForStuM::getLocalBufferMsg()
{
    QFile file("crash.dll");
    if(!file.exists())
    {
...
void YMQosManagerForStuM::getBePushedUrl()
{
...
void YMQosManagerForStuM::getDeviceInfo()
{
...
void YMQosManagerForStuM::getServerDateTime()
{
...
qint64 YMQosManagerForStuM::getTimeDifference()
{
    return timeDifference;
}

QJsonObject YMQosManagerForStuM::getBasicJsonData()
{
    QJsonObject dataObj;
...
bool YMQosManagerForStuM::getIsChangeChannel()
{
    return isChangeChannel;
}

void YMQosManagerForStuM::setChangeChannelValue(bool isChangeChannels)
{
    isChangeChannel = isChangeChannels;
}

QString YMQosManagerForStuM::makeJoinMicActionId()
{
...
QString YMQosManagerForStuM::getJoinMicActionId()
{
    return joinMicActionId;
}

QString YMQosManagerForStuM::getH5NeedBasicData()
{
...

{
    ...
    "data": {
        "applicationType": 1,
        "endTime": "2018-11-08 18:40:00",
        "hasMedia": 0,
        "lessonId": 1664085,
        "lessonSecondCount": 2400,
        "lessonType": 0,
        "nowRoleType": 101,
        "offSingle": 1,
        "qqSign": "eJxlj11PgzAYhe-5FaTXRltKHfWuYROnOFimmdtNQ6DDjo3x0QHL4n931iU28b19npzznrNl2zZ4Cxe3SZoejqXi6lQJYD-YAIKbP1hVMuOJ4rjJ-kExVLIRPNko0WiICCEOhKYjM1EquZFXg8KfI55rKG1WcN3zm*FeBORggkxF5hq*Tlb*dD5*JmiGxVCgoaYwdFjae-mye4Kyq*flgq53PWVjmky2q376yaL3mS-viiBScX3M8T6k2wAK7yUWfrxja8yCjyWNWnYaPRqVSu7FdZSL7kfEJcSgnWhaeSi14EBELg-rZcD6sr4BCXlcDQ__",
        "reportFlag": 0,
        "socketFlag": 1,
        "startFlag": 1,
        "startTime": "2018-11-08 18:00:00",
        "student": [
            {
                "functionSwitch": "",
                "headPicture": "http://static.yimifudao.com.cn/static-files/user_pics/stu_head_pic/male.png",
                "id": 206550,
                "mobileNo": "13816059261",
                "realName": "吴宝宝",
                "type": "A"
            }
        ],
        ...
        "teacher": {
            ...
            "headPicture": "http://static.yimifudao.com.cn/static-files/user_pics/1808221203481621.jpg",
            "mobileNo": "4236272",
            "realName": "马玲珑老师",
            "teacherId": 900002764
        },
        "title": "【编号1664085】 2018-11-08\n\t\t18:00- 18:40(数学) 马玲珑老师",
        "title_short": "1664085 数学 18:00- 18:40"
    },
    "message": "SUCCESS",
    "result": "success",
    "success": true
...
###{
    "MD5Pwd": "cfcd208495d565ef66e7dff9f98764da",
    "address": "116.62.196.136",
    "apiVersion": "2.4",
    "appVersion": "3.11.04.132",
    "deviceInfo": "LENOVO|LENOVO_MT_2347",
    "id": "900000584",
    "lat": "31.2243",
    "lng": "121.4768",
    "logTime": "2018-11-08 19:09:57",
    "mobileNo": "3464066",
    "plat": "L",
    "port": "5122",
    "token": "f93c3980730d4fc87f8e7c1d330d4b96",
    "udpPort": "5120",
    "userName": "pccc"
}
