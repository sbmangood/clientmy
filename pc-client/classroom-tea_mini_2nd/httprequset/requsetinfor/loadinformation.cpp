...
QString LoadInforMation::uploadImage(QString paths)
{
    ...
    {
        qDebug() << "======loading::uploadImage failed========" << dataObj;
    }
...
QString LoadInforMation::downLoadMedia(QString mediaUrl)
{
    ...
    obj.insert("coursewareUrl",mediaUrl);
    obj.insert("fileName",fileName);
    obj.insert("fileType",suffix);
    obj.insert("startDownLoadTime",QString::number(startDownLoadTime));
    obj.insert("endDownLoadTime",QString::number(QDateTime::currentMSecsSinceEpoch()));
