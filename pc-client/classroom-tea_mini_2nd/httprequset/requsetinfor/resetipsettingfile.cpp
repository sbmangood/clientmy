...
void ResetIpSettingFile::getGoodIplist(QString backData)
{
    ...
    QString url =  YMUserBaseInformation::miniUrl + "/marketing/app/api/t/agora/ip/list?";
    qDebug()<<QStringLiteral("url::")<<url;
    ...
    //data ="{\"message\": \"\",\"data\": [ {\"port\": \"5122\"ta\": [ {\"port\": \"5122\",\"udpPort\": \"5120\",\"ip\": \"123.59.155.57\"},{\"port\": \"5122\",\"udpPort\": \"5120\", \"ip\": \"123.59.155.57\"} ],\"result\": \"success\",\"code\": -1}";
    ...
    qDebug()<<QStringLiteral("优选ip列表")<<TemporaryParameter::gestance()->m_ipList;
}
