...
Item {
            ...
            Row{
                ...
                Rectangle{//上下台
                    ...
                    MouseArea{
                        ...
                        onClicked: {
                            ...
                            updateUserAuth(userId,userUp,authorize,userUp,camera);
                        }
                    }
                ...
                Rectangle{//授权
                    ...
                    MouseArea{
                        ...
                        onClicked: {
                            ...
                            updateUserAuth(userId,downStatus,userAuth,mircphon,camera);
                        }
                    }
                ...
                Rectangle{//麦克风
                    ...
                    MouseArea{
                        ...
                        Image {
                            anchors.fill: parent
                            source: online == 1 ? ((mircphon == "1" && downStatus == "1") ? "qrc:/miniClassImage/xb_hmc_on.png" : "qrc:/miniClassImage/xb_hmc_off.png") : "qrc:/miniClassImage/xb_hmc_forbid.png"
                        }
                        ...
                        onClicked: {
                            ...
                            updateUserAuth(userId,downStatus,authorize,userAudio,camera);
                        }
                    }
                ...
                Rectangle{//摄像头
                    ...
                    MouseArea{
                        ...
                        onClicked: {
                            ...
                            qosApiMgr.openCameraStatus(camera,curriculumData.getCurrentIp());
                            updateUserAuth(userId,downStatus,authorize,mircphon,camera);
                        }
                    }
    ...
    ListModel{
        id: bufferSysnRosterModel
    }

    function updateUserAuth(userId,userUp,userAuth,userAudio,userVideo){
        videoToolBackground.updateUserAuthorize(userId,userUp,userAuth,userAudio,userVideo);
        //trailBoardBackground.setUserAuth(userId, parseInt(userUp), parseInt(userAuth), parseInt(userAudio), parseInt(userVideo));
    }

    //添加花名册数据
    function addRosterData(dataArray){
        rosterModel.clear();
        console.log("===RosterData===",JSON.stringify(dataArray));
    ...
    function updateLocalUserAuth(userId,up,trail,audio,video){
        //console.log("===updateLocalUserAuth==",rosterModel.count,userId,up,trail,audio,video)
