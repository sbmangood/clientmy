...
Item {
    ...
    Component{
        ...
        Item{
            ...
            height: {
                if(isComplexClip){
                    return  multipleChoiceView.height * 0.5 + topicRow.height;
                }else{
                    return  multipleChoiceView.height * 0.5 + topicRow.height + multipleChoiceView.height * photosModel.count + 100 * heightRate;
                }
            }
            onHeightChanged: {
            ...
            Component.onCompleted: {
                console.log("=====clip11111111111=======",photosModel.count,clipStatus,index);
    ...
    Component.onCompleted: {
         console.log("=====666clip3333333333333=======",photosModel.count,clipStatus);
        //如果没有快照则直接截图
        if(photosModel.count == 0 && clipStatus){
            sigLoadingSuccess();
        }
