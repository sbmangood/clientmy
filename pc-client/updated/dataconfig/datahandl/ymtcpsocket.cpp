...
void YMTCPSocket::sendMsg(QString msg)
{
    ...
    {
        QString tempEnterRoomString = QString("content\":{\"flag\":\"%1\",\"logTime\":\"%2\",\"plat\":\"%3\",\"userName\":\"%4\",").arg(TemporaryParameter::gestance()->enterRoomStatus, StudentData::gestance()->m_logTime, StudentData::gestance()->m_plat, StudentData::gestance()->m_userName);
