  ...
  , offsetY(0.0)
{
    ...
    m_enterRoomMsg = QString("1#SYSTEM{\"command\":\"enterRoom\",\"content\":"
                             ...
                             "\"deviceInfo\":\"%8\",\"lat\":\"%9\",\"lng\":\"%10\",\"netType\":\"%11\",\"lessonType\":\"%12\",\"appSource\":\"YIMI\"},\"domain\":\"system\"}").arg(StudentData::gestance()->m_appVersion).arg(StudentData::gestance()->m_mD5Pwd).arg(StudentData::gestance()-> m_selfStudent.m_studentId).arg("audit").arg(StudentData::gestance()->m_sysInfo)
...
#ifdef USE_OSS_AUTHENTICATION
                m_pages[m_currentCourse].insert(a + m_currentPage, MessageModel(0, url, width, height, 1, 0));
#else
                m_pages[m_currentCourse].insert(a + m_currentPage, MessageModel(0, url, width, height, 1));
#endif
            }
        }
