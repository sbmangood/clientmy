...
//        }
        ...
        Image {
            ...
            //source: curriculumType == "O" ? "qrc:/images/icon_dingdan.png" : "qrc:/images/icon_shiting.jpg"
                                ...
                                for(var j = 0 ; j < listModel.count ;j++){
                                    if(listModel.get(j).userId  == "0") {
                                        ...
                                        if(audios == "1") {
                                            ...
                                            videoToolBackground.sigOperationVideoOrAudio( userId ,  userVideo ,  "0");
                                            externalCallChanncel.closeAudio("0");

                                        }else {
                                            listModel.setProperty(j,"userAudio","1");
                                            videoToolBackground.sigOperationVideoOrAudio( userId ,  userVideo ,  "1");
                                ...
                                for(var j = 0 ; j < listModel.count ;j++){
                                    if(listModel.get(j).userId  == "0") {
                                        ...
                                        if(videos == "1") {
                                            ...
                                            videoToolBackground.sigOperationVideoOrAudio( userId ,  "0" , userAudio);
                                            externalCallChanncel.closeVideo("0");
                                        }else {
                                            listModel.setProperty(j,"userVideo","1");
                                            videoToolBackground.sigOperationVideoOrAudio( userId ,  "1" , userAudio);
...
*/
                        ...
                        MouseArea{
                            anchors.fill: parent
                            onClicked: {
                                console.log("**********videoRenderBackGround*************", isteacher, userOnline, isVideo, userVideo, teacherIsOnline);
                            }
                        }
                    }
...
//                console.log("list[i] ==",list[j]);
                ...
                console.log("====ListenInfo===",JSON.stringify(list));
...
*/
            ...
            listModel.append( { "userId":list[tempInt]
                                 , "userName":curriculumData.getUserName( list[tempInt] )
                                 , "userOnline":curriculumData.justUserOnline( list[tempInt] )
                                 , "userAuth":curriculumData.getUserIdBrushPermissions( list[tempInt] )
                                 , "isVideo":curriculumData.getIsVideo()
                                 , "userAudio":curriculumData.getUserPhone( list[tempInt] )
                                 , "userVideo":curriculumData.getUserCamcera( list[tempInt] )
                                 , "imagePath":curriculumData.getUserUrl( list[tempInt] )
                                 , "isteacher":curriculumData.isTeacher(list[tempInt])
                                 , "supplier":curriculumData.getUserChanncel()
                                 , "volumes":"0"
                             }
                             );
