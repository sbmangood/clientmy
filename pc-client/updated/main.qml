...
Window {
    ...
    Rectangle{
        ...
        BrushWidget{
            ...
            anchors.top:  parent.top
            anchors.topMargin:  62 * fullHeights / 900
            width: 245 * fullWidths / 1440
            height: 186  * fullHeights / 900
            visible: false
            focus: false
            z:10
            onFocusChanged: {
        ...
        EraserWidget{
            ...
            anchors.leftMargin: -15 * fullWidths / 1440
            anchors.top:  parent.top
            anchors.topMargin:  58 * 2 * leftMidWidths + 18 * leftMidWidths
            width: 122 * fullWidths / 1440
            height: 110  * fullHeights / 900
            z:10
            visible: false
            focus: false
            onFocusChanged: {
        ...
        InterfaceWidget{
            ...
            anchors.leftMargin: -15 * fullWidths / 1440
            anchors.top:  parent.top
            anchors.topMargin: 58 * leftMidWidths + 40 * leftMidWidths
        ...
        PictureWidget{
            ...
            anchors.leftMargin: -15 * fullWidths / 1440
            anchors.top:  parent.top
            anchors.topMargin:  58 * 4 * leftMidWidths + 35 * leftMidWidths
        ...
        GraphicWidget{
            ...
            anchors.leftMargin: -15 * fullWidths / 1440
            anchors.top:  parent.top
            anchors.topMargin:  58 * 5 * leftMidWidths + 50 *   leftMidWidths
