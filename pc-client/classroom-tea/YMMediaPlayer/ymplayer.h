...
#include<QTimer>
typedef  void (*OnRenderCallBack)(QImage, int, void*);
...
class YMPlayer : public QThread
{
    ...
    public:
        ...
        static void onRenderCallBack(QImage img, int pts, void *data);
        int prepareCommon(PlayerState *ps);
        static bool playFinishedFlag ;

        void closeVideoOutput();
    ...
    signals:
        ...
        void playFinished();
        void sigCurrentTime(int currentTime);//当前播放时间
