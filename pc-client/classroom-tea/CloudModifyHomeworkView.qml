...
Popup {
    ...
    onDataModelChanged: {
        for(var a = 0; a<workModel.count; a ++)
        {
            if(dataModel.id == workModel.get(a).id)
            {                 
                return;
            }
        }
    ...
    function resetModifyView(questionData)
    {
        ...
        {
            //            console.log("判断id是否相同1:", questionId, dataModel.id)
            //            console.log("判断id是否相同2:", score, questionStatus, childQuestionId)
            if(questionId == dataModel.id )
            {
                console.log("判断id是否相同3:",i,workModel.count, workModel.get(i).childQuestionId, childQuestionId,workModel.get(i).childQuestionId)
                if( workModel.get(i).childQuestionId == "" || childQuestionId == null || childQuestionId == "" )
                {
                    console.log("没有子题目:",questionStatus,score,questionData.errorReason)
                    ...
                    workModel.get(i).isRight = questionStatus;
                    workModel.get(i).questionStatus = questionStatus;
                    workModel.get(i).oldScore = score;
                    //                    console.log(workModel.get(i).isCompare,"workModel.1111get(i)",workModel.get(i).errorName)
                    break;
                }
                else
                {
                    //                    console.log("判断id是否相同6:", childQuestionId, workModel.get(i).childQuestionId)
                    //判断子节点id是否相同
                    if(childQuestionId == workModel.get(i).childQuestionId)
                    {
                        //console.log("判断id是否相同7:", workModel.get(i).childQuestionId, childQuestionId)
    ...
    ListView{
        ...
        anchors.top: parent.top
        anchors.topMargin: 25 * widthRates
        anchors.horizontalCenter: parent.horizontalCenter
    }
        ...
        Item{
            ...
            Row{
                ...
                MouseArea{
                    ...
                    enabled: questionType <= 3 ? false : teacherType == "T" ? true : false
                    visible: {
                    ...
                    Image{
                        ...
                        source: {
                            if(questionType <= 3){
                                return "qrc:/newStyleImg/pigai_dui_sed@2x.png"
                            }
                    ...
                    onClicked: {
                        ...
                        if(isCompare == -1){
                            isCompare = 1;
                            checked = true;
                            yesImg.source = "qrc:/newStyleImg/pigai_dui_sed@2x.png"
                            noBut.visible = false;
                ...
                MouseArea{
                    ...
                    Image{
                        ...
                        source: {
                            if(isRight == 2){
                                return "qrc:/newStyleImg/pigai_cuo@2x.png";
                            }

                            if(isRight == 0){
                                if(questionType <= 3){
                                    return "qrc:/newStyleImg/pigai_cuo_sed@2x.png";
                                }
                    ...
                    onClicked: {
                        if(isCompare == -1){
                            ...
                            halfBut.visible = false;
                            noImg.source = "qrc:/newStyleImg/pigai_cuo_sed@2x.png";
                            ...
                            yesBut.visible = true;
                            halfBut.visible = true;
                            noImg.source = "qrc:/newStyleImg/pigai_cuo@2x.png";
                            scoreCombox.visible =false;
                ...
                MouseArea{
                    ...
                    cursorShape: Qt.PointingHandCursor
                    anchors.verticalCenter: parent.verticalCenter
                    enabled: teacherType == "T" ? true : false
                    visible: {
                        if(questionType <= 3){
                            return false
                        }
                    ...
                    Image{
                        ...
                        source:{
                            if(model.correStatus == 2){
                                return "qrc:/newStyleImg/pigai_bandui@2x.png";
                            }
                            isRight == 2 ? "qrc:/newStyleImg/pigai_bandui_sed@2x.png"  : "qrc:/newStyleImg/pigai_bandui@2x.png"
                        }
                    }
                    ...
                    onClicked: {
                        ...
                        if(isCompare == -1){
                            ...
                            noBut.visible = false;
                            yesBut.visible = false;
                            halfImg.source = "qrc:/newStyleImg/pigai_bandui_sed@2x.png"
                            ...
                            noBut.visible = true;
                            yesBut.visible = true;
                            halfImg.source = "qrc:/newStyleImg/pigai_bandui@2x.png"
                            scoreCombox.visible =false;
                            errorCombox.visible = false;
                        }
                        questionStatus = 2;
    ...
    function updateErrorList(dataObject){
        ...
        if(dataObject == {}  || dataObject == undefined){
            console.log("get errorReason Fail");
            return;
        }
