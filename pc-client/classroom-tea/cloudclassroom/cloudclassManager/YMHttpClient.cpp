...
QString YMHttpClient::getRunUrl(int urlType)
{
    ...
    if(tempUrl.contains("pre-"))
    {
        ...
        answerUrl = "pre-htimg.yimifudao.com.cn";
    }
    else if(tempUrl.contains("stage-"))
    {
        m_enEnvironment = ENVIRONMENT_STAGE;
        answerUrl = "stage-htimg.yimifudao.com.cn";
    }
    else if(tempUrl.contains("dev-"))
    {
        m_enEnvironment = ENVIRONMENT_DEV;
        answerUrl = "dev-htimg.yimifudao.com.cn";
    }else if(tempUrl.contains("stage3-"))
    {
        answerUrl = "stage3-htimg.yimifudao.com.cn";
    }else if(tempUrl.contains("stage2-"))
    {
        answerUrl = "stage2-htimg.yimifudao.com.cn";
    }else if(tempUrl.contains("test-"))
    {
        answerUrl  = "htimg.yimifudao.com.cn";
    }
    else
    {
        if(tempUrl.split("-").size() >= 2)
        {
           answerUrl = tempUrl.split("-").at(0) + "-htimg.yimifudao.com.cn";
        }else
        {
            m_enEnvironment = ENVIRONMENT_API;
            answerUrl  = "htimg.yimifudao.com.cn";
