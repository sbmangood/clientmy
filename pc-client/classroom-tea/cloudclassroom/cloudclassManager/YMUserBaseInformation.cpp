...
int YMUserBaseInformation::offSingle = false;
int YMUserBaseInformation::reportFlag = 0;
int YMUserBaseInformation::lessonType = 0;
int YMUserBaseInformation::applicationType = 0;
int YMUserBaseInformation::subjectId = 0;

QString YMUserBaseInformation::endLessonH5Url = "";

long YMUserBaseInformation::currentDateTimes = 0;

QString YMUserBaseInformation::aStudentName = "";//A学生真实姓名
