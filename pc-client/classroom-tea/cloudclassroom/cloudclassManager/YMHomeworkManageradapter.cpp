...
bool YMHomeWorkManagerAdapter::getFinishLessonWork(QString lessonWorkId)
{
    ...
    {
        qDebug() << "===YMHomeWorkManagerAdapter::getFinishLessonWork failed===" << objectData;
    }
...
QJsonArray YMHomeWorkManagerAdapter::getErrReason()
{
    ...
    {
        qDebug() << "===YMHomeWorkManagerAdapter::getErrReason failed===" << dataArray;
    }
...
bool YMHomeWorkManagerAdapter::getStudentIsFinish(QString lessonWorkId)
{
    ...
    {
        qDebug() << "===YMHomeWorkManagerAdapter::getStudentIsFinish failed===" << objectData;
    }
...
bool YMHomeWorkManagerAdapter::getIsCommented(QString lessonWorkId)
{
    ...
    {
        qDebug() << "===YMHomeWorkManagerAdapter::getIsCommented failed===" << objectData;
    }
