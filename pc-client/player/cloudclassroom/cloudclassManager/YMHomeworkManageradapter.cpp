...
QJsonObject YMHomeWorkManagerAdapter::getLessonWorkList(QString pageIndex, QString lessonWorkStatus)
{
    ...
    QString url = m_httpClient->httpUrl + "/homework/getLessonWorkList";//https://
    QByteArray dataByte = m_httpClient->httpPostForm(url, reqParm);
    QJsonObject objectData = QJsonDocument::fromJson(dataByte).object();
    qDebug() << "getLessonWorkList::getLessonWorkList::objectData" << objectData.size();
    return objectData;
}
...
bool YMHomeWorkManagerAdapter::saveStudentAnswer(QString lessonWorkId, QString questionId, QString studentAnswer, QString useTime, QString photos, QString writeImages)
{
    ...
    //QString url = m_httpClient->httpUrl + "/homework/saveStudentAnswer";//https://
    ...
    {
        qDebug() << "YMHomeWorkManagerAdapter::saveStudentAnswer" << objectData;
    }
...
bool YMHomeWorkManagerAdapter::updateLessonWorkStatus(QString lessonWorkId)
{
    ...
    {
        qDebug() << "YMHomeWorkManagerAdapter::updateLessonWorkStatus" << objectData;
    }
...
QJsonObject YMHomeWorkManagerAdapter::getAnswerCard(QString lessonWorkId)
{
    ...
    //QString url = m_httpClient->httpUrl + "/homework/getAnswerCard";//https://
    QString url = "http://192.168.1.108:9026/api/homework/getAnswerCard";
    QByteArray dataByte = m_httpClient->httpPostForm(url, reqParm);
    QJsonObject objectData = QJsonDocument::fromJson(dataByte).object();
    qDebug() << "YMHomeWorkManagerAdapter::getAnswerCard::result" << objectData.value("result").toString();
    return objectData;
...
bool YMHomeWorkManagerAdapter::updateReaded(QString lessonWorkId)
{
    ...
    {
        qDebug() << "YMHomeWorkManagerAdapter::updateReaded" << objectData;
    }
...
//    qDebug() << "YMHomeWorkManagerAdapter::getQuestionStatus" << result;
    if(!result.contains("success"))
    {
        qDebug() << "YMHomeWorkManagerAdapter::getQuestionStatus::failData" << objectData;
    }
...
bool YMHomeWorkManagerAdapter::getFinishLessonWork(QString lessonWorkId)
{
    ...
    qDebug() << "===YMHomeWorkManagerAdapter::getFinishLessonWork::Fail===" << objectData;
    return isFinish;
}
    ...
    double score/*得分（主观题才有）*/)
{
    ...
    qDebug() << "===YMHomeWorkManagerAdapter::saveTeacherComment::fail===" << objectData << isFinish;
    return isFinish;
}
...
QJsonObject YMHomeWorkManagerAdapter::getHomeworkDetailList(QString lessonWorkId)
{
    ...
    qDebug() << "===YMHomeWorkManagerAdapter::getHomeworkDetailList===" << result;
    if(result == "success")
    {
        data = objectData.value("data").toObject();
        return data;
    }
    qDebug() << "===YMHomeWorkManagerAdapter::getHomeworkDetailList===" << result << objectData;
    return data;
}
...
QJsonObject YMHomeWorkManagerAdapter::getDetailByOne(QString lessonWorkId, int orderNumber)
{
    ...
    qDebug() << "===YMHomeWorkManagerAdapter::getDetailByOne===" << result << data;
    return data;
}
...
QJsonArray YMHomeWorkManagerAdapter::getErrReason()
{
    ...
    qDebug() << "===YMHomeWorkManagerAdapter::getErrReason===" << result << objectData;
    return dataArray;
}
...
bool YMHomeWorkManagerAdapter::getStudentIsFinish(QString lessonWorkId)
{
    ...
    qDebug() << "===YMHomeWorkManagerAdapter::getStudentIsFinish===" << isFinish << objectData;
    return isFinish;
}
...
bool YMHomeWorkManagerAdapter::getIsCommented(QString lessonWorkId)
{
    ...
    qDebug() << "===YMHomeWorkManagerAdapter::getIsCommented===" << isCommented << objectData;
    return isCommented;
}
