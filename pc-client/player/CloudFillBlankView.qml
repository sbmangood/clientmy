...
Item {
    ...
    Component{
        ...
        Item{
            ...
            height: {
                var currentLength = questionItemsModel == [] || questionItemsModel ==null ? 1 : questionItemsModel.length;
                return fillblankView.height * 0.5 +  currentLength * 28 * heightRate + topicRow.height + photosModel .count * fillblankView.height
            }
            onHeightChanged: {
                if(clipStatus){
            ...
            ListView{
                ...
                height: parent.height  - topicRow.height  - 50 * heightRate -  photosModel .count * fillblankView.height
                anchors.top: topicRow.bottom
                anchors.topMargin: 10 * heightRate
                anchors.horizontalCenter: parent.horizontalCenter
