...
//    qDebug() << "=======doUpgrade_LocalLogInfo_To_Server=========== replyData" << replyData.length() <<imageReply->errorString();
    //qDebug() << "DebugLog::doUpgrade_LocalLogInfo_To_Server_Once dataObject: " << dataObject << StudentData::gestance()->m_userName << __LINE__;
    //QMessageBox::question(NULL, "Title", StudentData::gestance()->m_userName, QMessageBox::Ok);
