...
public:
    ...
    //抢答器
    Q_INVOKABLE void sendResponderMsg(int types, QString userName);
...
signals:
    ...
    void sigH5Courseware(int docType,QString h5Url);
    //设置播放动画
...
#ifdef USE_OSS_AUTHENTICATION
    MessageModel bufferModel = MessageModel(0, "", 1.0, 1.0,"","0", 0,false, 0);
#else
    MessageModel bufferModel = MessageModel(0, "", 1.0, 1.0,"", "1",0,false);
#endif
