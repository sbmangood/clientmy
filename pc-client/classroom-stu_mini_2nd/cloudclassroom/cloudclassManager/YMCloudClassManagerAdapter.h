...
class YMCloudClassManagerAdapter : public QObject
{
    ...
    private:
        ...
        QString apiUrl = StudentData::gestance()->apiUrl; //jyhd.yimifudao.com

        QString tempIp = StudentData::gestance()->teachingUrl;//"stage-jyhd.yimifudao.com"; // jyhd.yimifudao.com //47.100.68.102:9005
