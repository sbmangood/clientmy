...
Window {
    ...
    property bool isSynCompletes: false;
    ...
    Item{
        ...
        YMResponderViewForStu{
            ...
            {
                qosApiMgr.clickStuResponder();
                trailBoardBackground.sendResponderMsg(2,curriculumData.getUserName(0));
            }
        }
        //计时倒计时
        YMTimerView{
...
//            anchors.topMargin: rightWidthY
        ...
        BrushWidget{
            ...
            anchors.top:  parent.top
            anchors.topMargin: 375 * heightRate
        ...
        EraserWidget{
            ...
            anchors.rightMargin: 42 * heightRate
            anchors.top:  parent.top
            anchors.topMargin:  430 * heightRate
