            ...
            Item {
                ...
                Column {
                    ...
                    /*Row {
                        ...
                        Text {
                            text: isRight ? score + qsTr("分") : qsTr("0分")
                            font.pixelSize: 16 * heightRate
                            font.family: Cfg.DEFAULT_FONT
                            color: "green"
                        }
                    ...
                    Rectangle{
                        ...
                        MouseArea{
                            ...
                            drag.maximumX: 0
                            drag.minimumX: -(anserText.width -  textColumn.width)
                            cursorShape: Qt.PointingHandCursor
                            onMouseXChanged: {
                    ...
                    //                    Text {
                    //                        id:answerText
                    //                        visible: answerText.text == "" ? false : true
                    //                        text: {
                    //                            if(answerStr == ""){
                    //                                if(answerModel.length > 0){
                    //                                    var answer = answerModel[index] == undefined ? "" : answerModel[index].toString();
                    ...
                    Rectangle{
                        ...
                        MouseArea{
                            ...
                            drag.minimumX: -(analyerText.width * 3)
                            cursorShape: Qt.PointingHandCursor
                            onMouseXChanged: {
