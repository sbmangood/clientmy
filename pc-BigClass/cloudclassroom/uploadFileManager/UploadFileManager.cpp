...
void YMUpLoadFileManager::ProgressCallback(size_t increment, int64_t transfered, int64_t total, void* userData)
{
...
void YMUpLoadFileManager::run()
{
    if (is_runnable)
    {
        ...
        if(paramsObj.contains("envType"))
        {
            envType = paramsObj.take("envType").toString();
        }
