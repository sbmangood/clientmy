...
class PolygonPanel : public QQuickPaintedItem
{
    ...
    public:
        ...
        Q_INVOKABLE   void setInitWindowType( int types,QString boardId,QString dockId,QString itemId,int pageId,double lineWidth);
