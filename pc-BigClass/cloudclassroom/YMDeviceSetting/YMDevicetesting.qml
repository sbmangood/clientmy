...
Rectangle{
    ...
    property bool isCheckDevice: false;
    ...
    onDeviceSelecteIndexChanged: {
        if(deviceSelecteIndex == 1){
            soundTestView.visible = true;
            cameraTestView.visible = false;
            netTestView.visible = false;
            startTestButton.visible= true;
        }else if(deviceSelecteIndex == 2){
            soundTestView.visible = false;
            cameraTestView.visible = true;
            netTestView.visible = false;
            getCameraList();
            cameraStartBtn.visible = true;
            camerImageView.visible = false;
        }else{
            soundTestView.visible = false;
            cameraTestView.visible = false;
            netTestView.visible = true;
            netStartBtn.visible = true;
        }
    }
    ...
    Item {
        ...
        Row {
            ...
            MouseArea {
                ...
                hoverEnabled: true
                cursorShape: Qt.PointingHandCursor
                enabled: isCheckDevice ? false : true
    ...
    Item {
        ...
        Item{
            ...
            Row{
                ...
                Rectangle{
                    ...
                    border.color: "#6189EB"
                    radius: 4 * heightRate
                    visible: startTestButton.visible ? false :   isCheckDevice ?  false : true
                    color:"#00000000"
                    Text {
                        anchors.centerIn: parent
                        font.pixelSize: 16 * widthRate
            ...
            Column{
                ...
                Row{
                    ...
                    Rectangle{
                        ...
                        radius: 4 * heightRate
                        color:"#3D3F4E"
                        visible: cameraStartBtn.visible ? false : true
        ...
        Item {
            ...
            Image{
                ...
                visible: netStartBtn.visible ? true : isCheckDevice ? true : false
                source: {
                    if(countNumber == 3){
            ...
            Text {
                ...
                anchors.horizontalCenter: parent.horizontalCenter
                visible: netStartBtn.visible ? false : isCheckDevice ? true : false
            }
            ...
            Item{
                ...
                Column{
                    id: networkColumn
                    visible: netStartBtn.visible ? false : isCheckDevice ? false : true
                    anchors.fill: parent
                    spacing: 10 * heightRate
