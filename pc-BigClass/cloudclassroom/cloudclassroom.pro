...
SOURCES += main.cpp \
    ...
    httpclient.cpp \
    ymcrypt.cpp \
    screenshotsaveimage.cpp

RC_FILE = cloudclassroom.rc
...
HEADERS += $$PWD/lessonInfo/YMLessonManager.h \
    ...
    ymcrypt.h \
    dumphelper.h \
    screenshotsaveimage.h \
    classroomeventtype.h
...
include(./YMGeometricManager/geometricView.pri)
include(../common/pingback/pingback.pri)
