...
Rectangle {
    ...
    Row {
        ...
        MouseArea {
            ...
            Image {
                anchors.fill: parent
                source: parent.containsMouse ? "qrc:/redPackge/jianye1.png" : "qrc:/redPackge/jianye2.png"
            }
        ...
        MouseArea {
            ...
            Image {
                anchors.fill: parent
                source: parent.containsMouse ? "qrc:/redPackge/jiaye1.png" : "qrc:/redPackge/jiaye2.png"
            }
