...
{
    //"http://dev-h5.yimifudao.com/classAssignment?executionPlanId=" + classId +"&handleStatus=12&token=" + miniLessonManager.getToken()+"&className='"+classIndex+"'&title='"+classNameTitle+"'";
    //域名待修改
...
QString YMMiniLessonManager::getRunUrl()
{
    ...
    {
        tUrl = "https://dev-platform.yimifudao.com/v1.0.0";
    }else if(tUrl.contains("//stage-api"))
    {
        tUrl = "https://stage-platform.yimifudao.com/v1.0.0";
    }if(tUrl.contains("//pre-api"))
    {
        tUrl = "https://pre-platform.yimifudao.com/v1.0.0";
    }else
    {
        //线上 待定
    }
