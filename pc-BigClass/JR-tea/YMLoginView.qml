...
Rectangle{
    ...
    onAutoLoginChanged: {
        autoImage.source = autoLogin ? "qrc:/images/JrImage/login_btn_right.png" : "qrc:/images/JrImage/login_btn_right_grey.png"
        if(autoLogin){
            timer.running = true;
        }else{
            timer.stop();
    ...
    onSavePasswordChanged: {
        saveImage.source = savePassword ? "qrc:/images/JrImage/login_btn_right.png" : "qrc:/images/JrImage/login_btn_right_grey.png"
    }
    ...
    MouseArea{
        ...
        Text{
            ...
            color: parent.containsMouse ? "red" : "#dddddd"
...
//    }
    ...
    Item{
        ...
        Image{
            width: 155 * widthRate
            height: 53 * heightRate
            anchors.horizontalCenter: parent.horizontalCenter
            y: 90 * heightRate
            smooth: true
            fillMode: Image.PreserveAspectFit
            source: "qrc:/images/JrImage/loginLogo.png"
            MouseArea{
                anchors.fill: parent
                onClicked: {
                    stageTimer.restart();
    ...
    Item{
        ...
        Image{
            anchors.fill: parent
            source: 'qrc:/images/JrImage/leftlogo.png'
        }
    }
    ...
    Item{
        ...
        Row{
            ...
            Image{
                ...
                width: 12 * widthRate
                height: 12 * widthRate
                source: "qrc:/images/JrImage/login_btn_right_grey.png"
