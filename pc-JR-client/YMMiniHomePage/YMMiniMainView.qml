...
Item {
    ...
    YMLessonManagerAdapter{
        ...
        onLessonlistRenewSignal:{
            console.log("==onLessonlistRenewSignal4==")
            ...
            Row{
                ...
                Rectangle
                {
                    ...
                    MouseArea
                    {
                        ...
                        onReleased: {
                            ...
                            console.log("enterRoomClick4:",JSON.stringify(lessonInfo),userType,isStageEnvironment,calendarControl.currentDaytext)
                ...
                Rectangle
                {
                    ...
                    MouseArea
                    {
                        ...
                        enabled: hasDoc
                        onClicked: {
                            console.log("查看学习资料4",isStageEnvironment,strStage)
