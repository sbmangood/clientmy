...
void DebugLog::init_log(QString strAppFileName)
{
    ...
    //qDebug() << "DebugLog::init_log" << i << qPrintable(strAppName) << qPrintable(g_strAppFileName);
...
bool DebugLog::saveLogUrl(QString logUrl)
{
    ...
    qDebug() << "DebugLog::saveLogUrl" << url;
...
QString DebugLog::uploadLog_To_OSS(QString logPath)
{
    ...
    QString key = QString("appLog/%1/${%2}-${%3}_%4").arg(times.toString("yyyy/MM/dd")).arg("0").arg("yimifd-tea").arg(fileName);
