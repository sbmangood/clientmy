...
public:
    ...
    virtual void ProgressCallback(size_t increment, int64_t transfered, int64_t total, UpLoadFileInfo* fileInfoData);
...
signals:
    ...
    void sigUploadProgress(QString fileUrl, QString upFileMark, QString transferedPercent);// 上传进度信号
};
