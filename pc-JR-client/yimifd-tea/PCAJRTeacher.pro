...
SOURCES += main.cpp \
    ...
    agora/agoraengineeventhandler.cpp \
    agora/agorapacketobserver.cpp \
    YMDevicetesting.cpp \
...
# 设备检测模块Agora SDK引用
win32: LIBS += -L$$PWD/../../pc-common/common/AgoraSDK/lib/ -lagora_rtc_sdk
INCLUDEPATH += $$PWD/../../pc-common/common/AgoraSDK/include
DEPENDPATH += $$PWD/../../pc-common/common/AgoraSDK/lib
...
include(../../pc-common/qosManager/qosManager.pri)
include(../../pc-common/AESCryptManager/AESCryptManager.pri)
include(./lessonevaluation/lessonevaluation.pri)
include(./cloudDiskView/cloudDiskView.pri)
include(./uploadFileManager/uploadFileManager.pri)
DISTFILES +=
