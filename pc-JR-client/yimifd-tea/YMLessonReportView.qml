...
MouseArea{
            ...
            Column{
                ...
                MouseArea{
                    ...
                    onClicked: {
                        ...
                        var url = Write_ListenUrl + currentInfo.lessonId + "&userId="+currentInfo.userId + "&studentId="+ currentInfo.studentId + "&token=" + currentInfo.token +  "&appType=yimi&classType=0" + "/#/trial/lessonInfo";
    ...
    TipShowH5ReportView
    {
        ...
        onSigReportFinished:
        {
            console.log("onSigReportFinished....")
            reportFinished()
        }
    ...
    function updateUserInfo(lessonInfo,viewType)
    {
        currentInfo = lessonInfo
        lessonId = lessonInfo.lessonId

        if(viewType == 1)//编辑/查看报告
        {
            selectItem.visible = true;
        }else if(viewType == 2)//填写报告
        {
