...
Rectangle {
    ...
    YMLessonManagerAdapter{
        ...
        onLessonlistRenewSignal:{
            console.log("==onLessonlistRenewSignal1==")
            ...
            Row{
                ...
                Rectangle
                {
                    ...
                    MouseArea
                    {
                        ...
                        onReleased: {
                            ...
                            console.log("enterRoomClick1:",JSON.stringify(lessonInfo),userType,isStageEnvironment,calendarControl.currentDaytext)
                ...
                Rectangle
                {
                    ...
                    MouseArea
                    {
                        ...
                        enabled: hasDoc
                        onClicked: {
                            console.log("查看学习资料1",isStageEnvironment,strStage)
